...
\problem{1}
One problem using the companion matrix to get to the exact forecast for an AR(p).

\problem{1}
Problem 4.5 from Hamilton's book.

\problem{1}
One question about a stationary process that cannot be represented as an ARMA model.
