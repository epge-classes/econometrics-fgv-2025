...
\begin{frame}{\underline{Tentative} Weekly Topics}
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item The Lag Operator, AR and MA processes;
    \end{itemize}
    \item \textbf{Week 3:} 
    \begin{itemize}
      \item ARMA Models and Wold's Decomposition Theorem;
      \item Estimation of ARMA Models;
    \end{itemize}
    \item \textbf{Week 4:} 
    \begin{itemize}
    ...
    \item \textbf{Week 5:}
    \begin{itemize}
      \item GMM asymptotic theory + HAC estimation;
